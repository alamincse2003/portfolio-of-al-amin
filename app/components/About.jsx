...
const About = () => {
  return (
    <section
      id="about"
      className="bg-white dark:bg-zinc-900 py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-12 lg:px-24"
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 sm:gap-10 md:gap-12">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-zinc-700 dark:text-zinc-300 leading-relaxed mb-4 sm:mb-6 text-center md:text-left">
            Hi, I'm{" "}
